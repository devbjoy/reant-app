            ...
            <form wire:submit="loginSave">
              <div class="space-y-5">
                ...
                <div>
                  ...
                  <input type="email" id="email" wire:model.live="email" placeholder="info@gmail.com"
                ...
                <div class="flex items-center justify-between">
                  <div x-data="{ checkboxToggle: false }">
                    <label for="checkboxLabelOne"
                      ...
                      <div class="relative">
                        <input wire:model="remember" type="checkbox" id="checkboxLabelOne" class="sr-only"
