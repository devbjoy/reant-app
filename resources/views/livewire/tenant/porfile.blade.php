<div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
  <!-- Breadcrumb Start -->
  <div x-data="{ pageName: `Profile Info` }">
  ...
  <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
      ...
      <div class="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
        <div class="flex flex-col items-center w-full gap-6 xl:flex-row">
          <div class="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800">
            <img src="{{ asset('storage/' . auth()->guard('tenant')->user()?->image ?? '') }}" alt="user"
              class="w-full h-full object-cover">
          </div>
          <div class="order-3 xl:order-2">
            <h4 class="mb-2 text-lg font-semibold text-center text-gray-800 dark:text-white/90 xl:text-left">
              {{ auth()->guard('tenant')->user()?->first_name }} {{ auth()->guard('tenant')->user()?->last_name }}
            </h4>
      ...
      <form wire:submit.prevent="UpdateProfileInfo">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div class="sm:col-span-1">
            ...
            <input type="number" placeholder="Pin Number" wire:model="pin"
              class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
          </div>
          ...
          <div class="sm:col-span-1">
            ...
            <input type="file" wire:model="preview_image"
              class="focus:border-ring-brand-300 shadow-theme-xs focus:file:ring-brand-300 h-11 w-full overflow-hidden rounded-lg border border-gray-300 bg-transparent text-sm text-gray-500 transition-colors file:mr-5 file:border-collapse file:cursor-pointer file:rounded-l-lg file:border-0 file:border-r file:border-solid file:border-gray-200 file:bg-gray-50 file:py-3 file:pr-3 file:pl-3.5 file:text-sm file:text-gray-700 placeholder:text-gray-400 hover:file:bg-gray-100 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900  dark:text-white/90 dark:file:border-gray-800 dark:file:bg-white/[0.03] dark:file:text-gray-400 dark:placeholder:text-gray-400">

            @if ($preview_image)
              <div class="w-32 h-20 object-contain mt-2 relative group">
                <img src="{{ $preview_image->temporaryUrl() }}" alt="Preview"
    ...
    <div class="p-5 mb-6 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
      ...
      <form wire:submit.prevent="changePassword" class="pt-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div class="sm:col-span-1">
            ...
            <input wire:model="old_password" type="text" placeholder="Enter your old password"
            ...
            <div x-data="{ showPassword: false }" class="relative">
              ...
              <span @click="showPassword = !showPassword"
                ...
                <svg x-show="!showPassword" class="fill-gray-500 dark:fill-gray-400" width="20" height="20"
                  viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style="">
                  <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg x-show="showPassword" class="fill-gray-500 dark:fill-gray-400" width="20" height="20"
                  viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style="display: none;">
                  <path fill-rule="evenodd" clip-rule="evenodd"
