    ...
    <div :class="menuToggle ? 'flex' : 'hidden'"
      ...
      <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
        <a class="flex  items-center text-gray-700 dark:text-gray-400" href="#"
          ...
          <span class="text-theme-sm mr-1 block font-medium"> {{ auth()->guard('tenant')->user()?->first_name }}
            {{ auth()->guard('tenant')->user()?->last_name }} </span>
          ...
          <ul class="flex flex-col gap-1 border-b border-gray-200 pt-4 pb-3 dark:border-gray-800">
            <li>
              <a href="{{ route('tenant.profile') }}" wire:navigate
                class="group {{ request()->routeIs('tenant.profile') ? 'menu-item-active' : 'menu-item-inactive' }} text-theme-sm flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300 {{ request()->routeIs('admin.profile') ? 'menu-item-active' : 'menu-item-inactive' }}">
                <svg
                  class="fill-gray-500 {{ request()->routeIs('tenant.profile') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }} group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300"
