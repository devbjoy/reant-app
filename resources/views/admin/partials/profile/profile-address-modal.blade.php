<div class ="fixed inset-0 flex
  items-center justify-center p-5 overflow-y-auto z-99999" x-show="isProfileAddressModal"
  x-data="{ isProfileAddressModal: false }" x-init="Livewire.on('openPropertyModal', () => isProfileAddressModal = true)";>
